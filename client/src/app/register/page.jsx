  ...
  return (
    <main className='min-h-screen'>
      <div className="relative flex justify-center py-16">
        <div style={{ minWidth: "40%" }}>
          <div className="flex  shadow-lg flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-black">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              &quot;Only one account should be created per household, using the home number as the username. Then, the data of all the individuals in that household can be entered.&quot;
              </h4>
            </div>
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              <form className="space-y-6" >
                <div>
                  ...
                  <div className="mt-2">
                    <input id="name" name="name" type="text" autoComplete="name" required className="block w-full rounded-md border-0 py-1.5 px-2 text-black shadow-sm ring-1 ring-inset ring-yellow-400 placeholder:text-black focus:ring-2 focus:ring-inset focus:ring-yellow-200 sm:text-sm sm:leading-6" />
                  </div>
                </div>
        ...
        shadow-sm ring-1 ring-inset ring-yellow-400 placeholder:text-black px-2
        ...
        text-black shadow-sm ring-1 ring-inset ring-yellow-400 px-2
        placeholder:text-yellow-400 focus:ring-2 focus:ring-inset focus:ring-yellow-200 
        sm:text-sm sm:leading-6" />
                  </div>
                </div>
                {errorMessage && <p className='text-red-200 text-sm'>error</p>}
                <div className=''>
